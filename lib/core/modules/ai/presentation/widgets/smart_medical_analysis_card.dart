...
class SmartMedicalAnalysisCard extends StatelessWidget {
  const SmartMedicalAnalysisCard({super.key});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => AIMedicalAnalysisPage()),
        );
      },
      child: Container(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Analyze your Medical Reports with AI'.tr(),
